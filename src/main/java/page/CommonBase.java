...
public class CommonBase {
	...
	public void waitForVisiable(MobileElement element, AppiumDriver<MobileElement> driver) {
		WebDriverWait wait = new WebDriverWait(driver, 50);
		wait.until(ExpectedConditions.visibilityOf(element));
	}
	
	public void SendKeys(MobileElement element, AppiumDriver<MobileElement> driver, String key) {
		waitForVisiable(element, driver);
		element.clear();
